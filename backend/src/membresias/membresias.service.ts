...
export class MembresiasService {
  ...
  async renovar(empresaId: string, actorId: string, clienteId: string, dto: RenovarMembresiaDto) {
    ...
    // el ingreso se registra solo, sin pedirle nada al que renueva — si la
    // empresa no tiene el módulo "Cuentas" activo, simplemente no hay dónde
    // registrarlo y la membresía igual queda renovada con normalidad.
